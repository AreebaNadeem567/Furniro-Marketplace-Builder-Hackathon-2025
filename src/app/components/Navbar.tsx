...
//                 Contact
//               </Link>
//               <Link href="/signup" className="text-gray-800 hover:text-gray-600 px-3 py-2 text-base font-poppinsSemiBold">
//                 Signup
//               </Link>
//               <Link href="/login" className="text-gray-800 hover:text-gray-600 px-3 py-2 text-base font-poppinsSemiBold">
//                 Login
//               </Link>
//             </div>
...
//               <Link href="/signup" className="block px-3 py-2 text-base font-poppinsSemiBold text-gray-800 hover:text-gray-600">
//                 Signup
//               </Link>
//               <Link href="/login" className="block px-3 py-2 text-base font-poppinsSemiBold text-gray-800 hover:text-gray-600">
//                 Login
//               </Link>
//             </div>
...
import { useState } from 'react';
import Link from 'next/link';
import { User, Search, Heart, ShoppingCart } from 'lucide-react'; // Import icons from Lucide
import CartMenu from './CartMenu';
