...
//   // Handle page change and restrict page range to a maximum of 5 pages
//   const handlePageChange = (pageNumber: number) => {
//     if (pageNumber < 1) {
//       setCurrentPage(1); // Prevent going below 1
//     } else if (pageNumber > totalPages) {
//       setCurrentPage(totalPages); // Prevent going above totalPages
//     } else {
//       setCurrentPage(pageNumber);
//     }
//   };

//   // Calculate the page numbers to display (limit to 5 pages max)
...
//               className={`px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 text-gray-700 ${currentPage === pageNumber && 'bg-blue-500 text-white'}`}
//             >
//               {pageNumber}
//             </button>
//           ))}
