...
//       storedWishlist.push(product); // Add the product to wishlist
//       localStorage.setItem("wishlist", JSON.stringify(storedWishlist));

//       // Show success notification
//       toast.success("Added to Wishlist Successfully!", { autoClose: 3000 });

//       // After adding to wishlist, navigate to the wishlist page after the toast
//       setTimeout(() => {
//         router.push("/Wishslist");
//       }, 3000); // Delay redirection by the duration of the toast (3000ms)
//     }
//   };
...
//             </div>
//             <Button
//               className="flex items-center gap-2 text-white bg-blue-600 px-4 py-2 rounded-lg"
...
//             <div className="text-sm">Share:</div>
//             <div className="flex gap-6 mt-2">
//               <Link href="https://www.facebook.com" className="p-2 text-blue-600">
//                 <FaFacebookSquare className="w-8 h-8" />
//               </Link>
//               <Link href="https://www.instagram.com" className="p-2 text-pink-700">
//                 <FaInstagramSquare className="w-8 h-8" />
//               </Link>
//               <Link href="https://www.linkedin.com" className="p-2 text-blue-700">
